...
import ingjulianvega.ximic.hapet.configuration.PetParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(PetParameters petParameters) {
        this.petParameters = petParameters;
    }
    ...
    public ResponseEntity<ApiError> validationErrorHandler(PetException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(petParameters.getApi())
