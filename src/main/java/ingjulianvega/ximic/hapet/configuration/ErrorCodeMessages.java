...
public class ErrorCodeMessages {
    ...
    public static final String PET_NOT_FOUND_API_CODE = "401";
    public static final String PET_NOT_FOUND_ERROR = "PET_NOT_FOUND";
    public static final String PET_NOT_FOUND_MESSAGE = "No se encontró la mascota";
    public static final String PET_NOT_FOUND_SOLUTION = "Verifique los datos";
